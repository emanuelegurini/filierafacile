...
public class DefaultAssegnatoreAutomatico implements ValidazioneListener {
    ...
    @Override
    public void onCuratoreLibero(Long curatoreId) {
    ...
    private void tentaAssegnazioneAutomatica() {
        Optional<Long> curatoreLibero = statusTracker.getPrimoCuratoreLibero();
        ...
        if (curatoreLibero.isPresent()) {
            ...
            if (prossimaPratica.isPresent()) {
                Long curatoreId = curatoreLibero.get();
    ...
    private void assegnaPratica(DefaultPraticaValidazione pratica, Long curatoreId) {
    ...
    private void liberaCuratore(Long curatoreId) {
        if (curatoreId != null) {
            statusTracker.setCuratoreLibero(curatoreId);
